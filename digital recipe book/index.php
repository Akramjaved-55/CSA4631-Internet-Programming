...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand ml-5" href="http://localhost/re/index.php">My Food Recipe</a>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td id="recipeImage-<?= $recipeID ?>"><img src="http://localhost/re/uploads/<?php echo $recipeImage ?>" class="img-fluid" style="height: 50px; width: 90px" alt="Recipe Image"></td>
